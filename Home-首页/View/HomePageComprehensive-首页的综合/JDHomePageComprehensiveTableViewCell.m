...
- (void)setModel:(JDHomePageComprehensiveModel *)model{
    ...
    self.cooperationAgencyNumberLabel.attributedText = [[NSString stringWithFormat:@"%@个", model.auditApprovalProductCount] stringTurnAttributeString:@"个" withFont:12 withColor:UIColor.redColor];
    ...
    self.solveMoneyNumberLabel.attributedText = [[NSString stringWithFormat:@"%@个", model.loanAmountCount] stringTurnAttributeString:@"个" withFont:12 withColor:UIColor.redColor];
